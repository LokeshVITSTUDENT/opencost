...
func newKubeNodeLabelsMetric(node, uid, fqname string, labelNames []string, labelValues []string) KubeNodeLabelsMetric {
...
func (nam KubeNodeLabelsMetric) Write(m *dto.Metric) error {
	...
	labels = append(labels,
		&dto.LabelPair{Name: &nodeString, Value: &nam.node},
		&dto.LabelPair{Name: &uidString, Value: &nam.uid},
	)
	m.Label = labels
	return nil
}
